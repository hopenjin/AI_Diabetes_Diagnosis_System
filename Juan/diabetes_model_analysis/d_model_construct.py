...
df_d = pd.read_csv('./Juan/diabetes_model_analysis/archive/diabetes_binary_health_indicators_BRFSS2015.csv')

df_d = df_d.drop(columns=['Income','Education','Sex','PhysHlth','MentHlth','NoDocbcCost',
                   'AnyHealthcare','HvyAlcoholConsump','Veggies','Fruits','PhysActivity'
                   ,'Stroke','Smoker','CholCheck'])
